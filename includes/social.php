...
$icons = ['facebook' => ['fab fa-facebook-f', 'Facebook'], 'twitter' => ['fab fa-twitter', 'X'], 'linkedin' => ['fab fa-linkedin-in', 'LinkedIn'], 'instagram' => ['fab fa-instagram', 'Instagram']];
?>
<div class="social-links">
    <?php foreach ($icons as $key => [$cls, $label]): if (empty($site['social'][$key])) continue; ?>
        <a href="<?= e($site['social'][$key]) ?>" target="_blank" rel="noopener">
